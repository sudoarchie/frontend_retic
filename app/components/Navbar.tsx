...
export function Navbar({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    const eventOrganiserToken = localStorage.getItem("eventOrganiserToken");

    setShowUserLogin(!userToken); // Show user login if eventOrganiserToken is not present
    setShowOrgLogin(!eventOrganiserToken); // Show org login if userToken is not present
  }, []);

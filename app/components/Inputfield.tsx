...
interface InputFieldProps {
  ...
  register: UseFormRegister<Record<string, string | number>>; // Specify the register function type
  required?: boolean; // Optional: If you want to handle required validation here
}
  ...
  return (
    <div className={`relative h-10 min-w-[200px] ${className}`}>
      <input
        ...
        type={type}
        defaultValue={value}
        {...register(name, { required })} // Use register with field name and optional validation
